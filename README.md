...
- Orchestrate daily runs using Prefect
- Deliver insights through a Power BI executive dashboard


## Architecture

Azure Data Lake (Landing) -> Snowflake (Data Warehouse) -> dbt transformation (Raw -> Staging -> Marts) -> Semantic Model -> Power BI Dashboard
...
## Data model
The data model is structured as a star schema with fact and dimension tables, serving as the semantic layer for business analytics. 
